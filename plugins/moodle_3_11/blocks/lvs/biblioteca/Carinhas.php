...
class Carinhas {
	...
	/**
 	 * método para executar algum comportamento no momento em que uma instancia for criada
     */
	public function __construct() {
		$this->diretorioImagens = LVS_WWWROOT . '/imgs/carinhas/moodle3/';
		$this->diretorioTemplate = LVS_DIRROOT . '/pages/html/';
		$this->imagens = array(
			'MUITO_BOM' 		=> array('arquivo' => 'lv_emoji_azul.gif', 'descricao' => "MUITO_BOM"),
			'BOM'		 		=> array('arquivo' => 'lv_emoji_verde.gif', 'descricao' => "BOM"),
			'REGULAR' 			=> array('arquivo' => 'lv_emoji_amarelo.gif', 'descricao' => "REGULAR"),
			'FRACO' 			=> array('arquivo' => 'lv_emoji_laranja.gif', 'descricao' => "FRACO"),
			'NAO_SATISFATORIO' 	=> array('arquivo' => 'lv_emoji_vermelho.gif', 'descricao' => "NAO_SATISFATORIO"),
			'NEUTRO' 			=> array('arquivo' => 'lv_emoji_cinza.gif', 'descricao' => "NEUTRO")
		);
	}
	...
	/**
	 *	Retorna o html que contém a tabela likert de seleção de carinha. 
	 *  A tabela contém os cinco valores likert
	 *
	...
	/**
	 * 	Retorna um array que contém o relacionamento entre uma nota likert estendida 
	 *  e uma cor em hexadecimal
	 * 	
	 * 	@return array:string 
	 */
