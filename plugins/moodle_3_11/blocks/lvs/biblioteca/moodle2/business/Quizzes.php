...
class Quizzes extends GerenciadorAtividadesDistancia implements GerenciadorAtividades {
	...
	private function _calcularBeta($LVx, $carinhas) {
		// Ref: Tese SALES, 2010. p. 106
		// valores ponderados associados à Escala de Menções com itens de apreciação:
		//   "Muito-Bom" (Gif Azul - peso 3), "Bom" (Gif Verde - peso 2) e "Regular" (Gif Amarelo - peso 1)
		// Nik = 3*CP(4) + 2*CP(3) + 1*CP(2)
		$positividade = $LVx + 3 * $carinhas['azul'] + 2 * $carinhas['verde'] + $carinhas['amarela'];

		// valores ponderados associados à Escala de Menções com itens de apreciação:
		//   "Fraco"  (Gif Laranja - peso 1) e "Não Satisfatório" (Gif Vermelho - peso 2)
		// Nik = 1*CP(1) + 2*CP(0)
		//
		//   __c___  a = 10 (nota máxima do aluno), b = LVy, c = Lvx
		//   |    /  a² = b² + c² (pitagoras, triângulo retângulo)
		//   |   /   10² = lvy² + lvx²
		//   b  a    100 = lvy² + lvx²
		//   | /     lvy² = 100 - lvx²
		//   |/               _________
