...
/**
*  	Constroi e exibe as paginas html relacionada as atividades presenciais
*
*  	@category LVs
...
class DistanciaView {
	...
	/**
	 * 	Exibe a pagina html gerada no AVA
	 * 	@var \uab\ifce\lvs\view\AdapterView
	 */
	private $_adapterView;
	
	/**
	 * 	Contem os dados enviados utilizados na construção da pagina html
	 * 	@var array:mixed
	 */
	private $_data;
	...
	/**
	 *	Constroi e exibe a tela de configuracao de atividades a distancia
	 *
	 * 	@access public
	 */
	public function configurarAtividadesDistancia() {
		$this->_template = new Template(
		    'html/distancia/atividades_distancia.html'
		);
	...
	private function _adicionarQuizzes() {
		...
		if (count($quizzes) != 0) {
			...
			foreach ($quizzes as $quiz) {
				...
				$this->_template->DISTANCIA_ETAPA = '';
	...
	private function _adicionarForuns() {
		...
		if (count($foruns) != 0) {
			$this->_template->CONJUNTO_ATIVIDADES = 'Fórum(ns) LV';
	...
	*/
	...
	private function _anularDistanciasEtapas() {
		$this->_template->DISTANCIA_ETAPA1 = ''; 
		$this->_template->DISTANCIA_ETAPA2 = ''; 
		$this->_template->DISTANCIA_ETAPA3 = ''; 
		$this->_template->DISTANCIA_ETAPA4 = ''; 
		$this->_template->DISTANCIA_ETAPA5 = ''; 
		$this->_template->DISTANCIA_ETAPA6 = ''; 
		$this->_template->DISTANCIA_ETAPA7 = ''; 
		$this->_template->DISTANCIA_ETAPA8 = ''; 
		$this->_template->DISTANCIA_ETAPA9 = ''; 
		$this->_template->DISTANCIA_ETAPA10 = '';
	}
	
	/**
	 *	Recupera o conteudo criado no Template e o exibe em tela através do AdaptarView
	 *
	 *	@access private
	 */
	...
	/**
	 * 	Armazena os dados utilizados na construcao da tela de exibicao. 
	 *  E um 'magic method', nao chama-lo diretamente
	 */
